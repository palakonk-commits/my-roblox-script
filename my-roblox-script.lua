...
local teleportBtn = createButton("Teleport", "🌀", 465)

-- Info Labels
local targetLabel = Instance.new("TextLabel")
targetLabel.Position = UDim2.new(0, 15, 0, 530)
...
speedLabel.Position = UDim2.new(0, 15, 0, 560)
...
playersLabel.Position = UDim2.new(0, 15, 0, 590)
