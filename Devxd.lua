...
local aimbotFOV = 200  -- ขนาด FOV Circle
...
-- Aimbot FOV Circle (สีขาว อยู่กึ่งกลางจอตลอด)
local fovCircle = Drawing.new("Circle")
fovCircle.Radius = aimbotFOV
fovCircle.Thickness = 2
fovCircle.Color = Color3.new(1, 1, 1)  -- สีขาว
...
notify("🇹🇭 Thai Exploit Premium v2.5 โหลดสำเร็จ!\n- Aimbot ล็อกหัวใน FOV (วงกลมสีขาวกลางจอ)\n- ไม่ต้องกดคลิกขวา\nกด F เพื่อพับเมนู", 6)

print("🇹🇭 Thai Exploit Premium v2.5 - FOV Circle Edition (04 Jan 2026)")
